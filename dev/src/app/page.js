...
export default function Home() {
  return (
    <div className="min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center bg-gradient-to-b from-neutral-50 via-primary-50/20 to-accent-50/20 dark:from-neutral-900 dark:via-primary-900/10 dark:to-accent-900/10">
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto space-y-12">
          {/* Header Section */}
          <div className="text-center space-y-4">
            <h1 className="text-5xl font-bold font-Roboto text-neutral-500 dark:text-neutral-100 animate-fade-in-up text-shadow-md">
               Income Estimation
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="bg-white/70 dark:bg-neutral-800/70 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-neutral-200/50 dark:border-neutral-700/50 transform hover:scale-105 transition-all duration-300 animate-fade-in-up">
              ...
              <h3 className="text-xl font-semibold text-primary-700 dark:text-primary-400 mb-2 text-center text-gray-700">Accurate</h3>
            ...
            <div className="bg-white/70 dark:bg-neutral-800/70 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-neutral-200/50 dark:border-neutral-700/50 transform hover:scale-105 transition-all duration-300 animate-fade-in-up delay-100">
              <div className="text-3xl mb-4 text-center">🔒</div>
              <h3 className="text-xl font-semibold text-primary-700 dark:text-primary-400 mb-2 text-center text-gray-700">Secure</h3>
            ...
            <div className="bg-white/70 dark:bg-neutral-800/70 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-neutral-200/50 dark:border-neutral-700/50 transform hover:scale-105 transition-all duration-300 animate-fade-in-up delay-200">
              <div className="text-3xl mb-4 text-center">⚡</div>
              <h3 className="text-xl font-semibold text-primary-700 dark:text-primary-400 mb-2 text-center text-gray-700">Fast</h3>
